...
<div className="home-banner">
  ...
  <div className="avatar-container">
    <img className="avatar" src="https://res.cloudinary.com/redhero/image/upload/v1651095087/Portfolio/avatar_izcjci.png" alt=""/>
  </div>
  <div className="banner-text">
      <h1 className="banner-text-one">"Hi, I'm Jeff Lyons." </h1>
      <h2 className="banner-text-two">"I'm a Full-Stack Web Developer who enjoys Front-End Development, and creating awesome user experiences."</h2>
